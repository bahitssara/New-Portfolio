            ...
            <div className='portfolio'>
                    <section class="projects">
                        ...
                        <a href="https://bahitssara.github.io/QUIZAPP/"><img className="project-photo" src={QuizAppPic} alt="project" /></a>
                            ...
                            <p class="description">Quiz app to test knowledge of the all time best band around, The 1975. Uses basic HTML, CSS, JavaScript and jQuery to create a short interactive web app. </p>
                    </section>
                    ...
                    <section class="projects">
                        ...
                        <a href="https://github.com/bahitssara/Big-Music-Guy"><img className="project-photo" src={BigMusicGuy} alt="project" /></a>
                            ...
                            <p class="description">Web app for music lovers. Allows users to search a musician or band and recieve Youtube video interviews, recent news articles, and recommendations for similar artists. APIs used are Youtube API, News API, and TasteDive API. Technologies used to make up the app are HTML, CSS, JavaScript, and jQuery.</p>
                    </section>
            </div>
        )
    }
